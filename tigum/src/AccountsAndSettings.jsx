                ...
                <div className="col-sm-6">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <p className="card-text">You are {userAcc.firstname} {userAcc.lastname}</p>
                      <p className="card-text">Email: {userAcc.email}</p>
                      <a href="#" className="btn btn-primary" onClick={()=> {setShow(true);
                      setFirstname(userAcc.firstname);
                      setLastname(userAcc.lastname)}}>Update Account</a>
                      <a href="#" className="btn btn-primary" onClick={()=> {setShowChangePassword(true)
                      }}>Change Password</a>
                    </div>
                  </div>
                </div>
